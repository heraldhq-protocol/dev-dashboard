...
const columns = [
  {
    accessorKey: "id",
    header: "ID",
    cell: ({ row }: { row: { original: FailedLog } }) => (
      <span className="font-mono text-text-secondary">{row.original.id}</span>
    ),
  },
  {
    accessorKey: "wallet",
    header: "Wallet",
    cell: ({ row }: { row: { original: FailedLog } }) => (
      <span className="font-mono text-teal">{row.original.wallet}</span>
    ),
  },
  {
  ...
  },
  {
    ...
    header: "Reason",
    cell: ({ row }: { row: { original: FailedLog } }) => (
      <span className="text-red font-semibold">{row.original.reason}</span>
    ),
  },
];
